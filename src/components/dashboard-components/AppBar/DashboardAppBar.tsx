...
} from '@/components/dashboard-components/AppBar/DashboardAppBar.type';
 ...
 */
const ThemeToggle = dynamic(() => import('@/components/dashboard-components/ThemeToggle/ThemeToggle'), {
  ssr: false,
